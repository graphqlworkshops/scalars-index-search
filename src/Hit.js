  ...
  return (
    <div>
      ...
      <div className="hit-link">
        {props.hit &&
          props.hit.package &&
          props.hit.package.links &&
          props.hit.package.links.npm && (
            <Link styleName="npm-button" href={props.hit.package.links.npm}>
              <svg
                viewBox="0 0 18 7"
        ...
        {props.hit &&
          props.hit.package &&
          props.hit.package.links &&
          props.hit.package.links.repository && (
            <Link
              styleName="github-button"
              href={props.hit.package.links.repository}
            >
              <svg
        ...
        {!props.hit.package && props.hit.readme && (
          <Link styleName="open-button" href={props.hit.readme}>
            {' '}
            Read Me
          </Link>
        )}
